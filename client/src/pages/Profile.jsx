                        ...
                        userProfile._id === userId ?
                            ...
                            <div className="profileControlBtns">
                                ...
                                <button type="button" className="btn btn-primary"
                                        onClick={() => setIsUpdating(true)}>Edit
                                </button>
                                    ...
                                    localStorage.getItem('following').includes(userProfile._id) ?
                                        <>
                                            <button onClick={() => handleUnFollow(userProfile._id)}
                                                    style={{backgroundColor: 'rgb(224, 42, 42)'}}>Unfollow
                                            </button>
            ...
            <div className='profileEditCard' style={!isUpdating ? {display: 'none'} : {display: "flex"}}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1"
                           onChange={(e) => setUpdateProfileUsername(e.target.value)} value={updateProfileUsername}/>
                </div>
                <div class="mb-3">
                    <label for="editAbout" class="form-label">About</label>
                    <input type="text" class="form-control" id="editAbout"
                           onChange={(e) => setUpdateProfileAbout(e.target.value)} value={updateProfileAbout}/>
                </div>
                    ...
                    return (
                        ...
                        <div className="Post" key={post._id}>
                            ...
                            <div className="postTop">
                                ...
                                <button className='btn btn-danger deletePost'
                                        onClick={() => handleDeletePost(post._id)}>Delete
                                </button>
                            </div>
                                ...
                                <div className="supliconcol">

                                    {
                                        post.likes.includes(localStorage.getItem('userId')) ?
                                            ...
                                            <AiTwotoneHeart className='support reactbtn'
                                                            onClick={() => handleUnLike(localStorage.getItem('userId'), post._id)}/>

                                            :

                                            <AiOutlineHeart className='support reactbtn'
                                ...
                                <div className="makeComment">
                                    ...
                                    {comment.length === 0 ?
                                        ...
                                        <button className='btn btn-primary'
                                                onClick={() => handleComment(post._id, localStorage.getItem('username'))}>comment</button>
                                    }
                                </div>
